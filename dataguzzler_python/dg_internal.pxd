...
cdef extern from "dg_internal/conn.h":
    cdef struct Conn:
        ConnBuf *InStream
        int Auth
        pass
...
cdef extern from "dg_internal/util.h":
     pass

cdef extern from "dg_internal/main.h":
     struct AtExitFunc:
         pass
     pass
...
cdef extern from "dg_internal/init.h":
     struct InitAction:
         int Type
         char *Name
         dg_StringBuf *Params
...
cdef extern from "dg_internal/mod.h":
    cdef struct Module:
        pass
...
cdef extern from "dg_internal/library.h":
    void StartLibrary(InitAction *Init,char *dg_bindir)
    pass



cdef extern from "dg_internal/rpc.h":
